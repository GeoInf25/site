  ...
  switch (output.type) {
    ...
    case "execution-denied": {
      return convertScalarOutput(
        (_a2 = output.reason) != null ? _a2 : "Tool call execution denied."
      );
    }
    case "json":
    case "error-json":
            ...
            switch (output.type) {
              ...
              case "execution-denied":
                outputValue = convertScalarOutput(
                  (_y = output.reason) != null ? _y : "Tool call execution denied."
                );
                break;
              case "json":
              case "error-json":
...
var jsonObjectSchema = import_v422.z.record(import_v422.z.string(), jsonValueSchema2.optional());
var openaiResponsesUsageSchema = import_v422.z.intersection(
  jsonObjectSchema,
  import_v422.z.object({
    input_tokens: import_v422.z.number(),
    input_tokens_details: import_v422.z.intersection(
      jsonObjectSchema,
      import_v422.z.object({
    ...
    output_tokens_details: import_v422.z.intersection(
      jsonObjectSchema,
      import_v422.z.object({
    ...
    total_tokens: import_v422.z.number().optional()
  })
);
...
var openaiLanguageModelResponsesOptionsSchema = (0, import_provider_utils29.lazySchema)(
  () => (0, import_provider_utils29.zodSchema)(
    import_v423.z.object({
       ...
       */
      reasoningEffortUpdate: import_v423.z.enum(["low", "medium", "high", "xhigh", "max"]).optional(),
      /**
...
var OpenAIResponsesLanguageModel = class {
  ...
  async getArgs({
    ...
    const baseArgs = {
      ...
      // model-specific settings:
      ...isReasoningModel && (resolvedReasoningEffort != null || (openaiOptions == null ? void 0 : openaiOptions.reasoningSummary) != null || (openaiOptions == null ? void 0 : openaiOptions.reasoningMode) != null || (openaiOptions == null ? void 0 : openaiOptions.reasoningContext) != null) && {
        reasoning: {
    ...
    if (isReasoningModel) {
      ...
      if (modelCapabilities.supportedReasoningEfforts != null && (baseArgs.top_logprobs != null || ((_i = baseArgs.include) == null ? void 0 : _i.includes("message.output_text.logprobs")))) {
        baseArgs.top_logprobs = void 0;
    ...
    const shellToolEnvType = (_m = (_l = (_k = tools == null ? void 0 : tools.find(
      (tool) => tool.type === "provider" && tool.id === "openai.shell"
    )) == null ? void 0 : _k.args) == null ? void 0 : _l.environment) == null ? void 0 : _m.type;
    ...
    const result = {
      stream: checkedResponse.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            var _a3, _b2, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H, _I, _J, _K, _L, _M, _N, _O, _P, _Q, _R, _S;
            if (options.includeRawChunks) {
              controller.enqueue({ type: "raw", rawValue: chunk.rawValue });
            }
            if (!chunk.success) {
            ...
            if (isResponseOutputItemAddedChunk(value)) {
              ...
              if (value.annotation.type === "url_citation") {
                controller.enqueue({
                  type: "source",
                  sourceType: "url",
                  id: (_I = (_H = (_G = self.config).generateId) == null ? void 0 : _H.call(_G)) != null ? _I : (0, import_provider_utils31.generateId)(),
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_L = (_K = (_J = self.config).generateId) == null ? void 0 : _K.call(_J)) != null ? _L : (0, import_provider_utils31.generateId)(),
                  mediaType: "text/plain",
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_O = (_N = (_M = self.config).generateId) == null ? void 0 : _N.call(_M)) != null ? _O : (0, import_provider_utils31.generateId)(),
                  mediaType: "text/plain",
                  title: value.annotation.filename,
                  filename: value.annotation.filename,
                  providerMetadata: {
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_R = (_Q = (_P = self.config).generateId) == null ? void 0 : _Q.call(_P)) != null ? _R : (0, import_provider_utils31.generateId)(),
                  mediaType: "application/octet-stream",
