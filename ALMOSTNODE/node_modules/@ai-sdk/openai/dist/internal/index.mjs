...
var jsonObjectSchema = z18.record(z18.string(), jsonValueSchema.optional());
var openaiResponsesUsageSchema = z18.intersection(
  jsonObjectSchema,
  z18.object({
    input_tokens: z18.number(),
    input_tokens_details: z18.intersection(
      jsonObjectSchema,
      z18.object({
    ...
    output_tokens_details: z18.intersection(
      jsonObjectSchema,
      z18.object({
    ...
    total_tokens: z18.number().optional()
  })
);
...
var openaiLanguageModelResponsesOptionsSchema = lazySchema17(
  () => zodSchema17(
    z19.object({
       ...
       */
      reasoningEffortUpdate: z19.enum(["low", "medium", "high", "xhigh", "max"]).optional(),
      /**
