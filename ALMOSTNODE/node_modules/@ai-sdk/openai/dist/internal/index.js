...
var jsonObjectSchema = import_v418.z.record(import_v418.z.string(), jsonValueSchema.optional());
var openaiResponsesUsageSchema = import_v418.z.intersection(
  jsonObjectSchema,
  import_v418.z.object({
    input_tokens: import_v418.z.number(),
    input_tokens_details: import_v418.z.intersection(
      jsonObjectSchema,
      import_v418.z.object({
    ...
    output_tokens_details: import_v418.z.intersection(
      jsonObjectSchema,
      import_v418.z.object({
    ...
    total_tokens: import_v418.z.number().optional()
  })
);
...
var openaiLanguageModelResponsesOptionsSchema = (0, import_provider_utils27.lazySchema)(
  () => (0, import_provider_utils27.zodSchema)(
    import_v419.z.object({
       ...
       */
      reasoningEffortUpdate: import_v419.z.enum(["low", "medium", "high", "xhigh", "max"]).optional(),
      /**
            ...
            if (isResponseOutputItemAddedChunk(value)) {
              ...
              if (value.annotation.type === "url_citation") {
                controller.enqueue({
                  type: "source",
                  sourceType: "url",
                  id: (_I = (_H = (_G = self.config).generateId) == null ? void 0 : _H.call(_G)) != null ? _I : (0, import_provider_utils36.generateId)(),
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_L = (_K = (_J = self.config).generateId) == null ? void 0 : _K.call(_J)) != null ? _L : (0, import_provider_utils36.generateId)(),
                  mediaType: "text/plain",
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_O = (_N = (_M = self.config).generateId) == null ? void 0 : _N.call(_M)) != null ? _O : (0, import_provider_utils36.generateId)(),
                  mediaType: "text/plain",
                  title: value.annotation.filename,
                  filename: value.annotation.filename,
                  providerMetadata: {
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_R = (_Q = (_P = self.config).generateId) == null ? void 0 : _Q.call(_P)) != null ? _R : (0, import_provider_utils36.generateId)(),
                  mediaType: "application/octet-stream",
