...
var jsonObjectSchema = z22.record(z22.string(), jsonValueSchema2.optional());
var openaiResponsesUsageSchema = z22.intersection(
  jsonObjectSchema,
  z22.object({
    input_tokens: z22.number(),
    input_tokens_details: z22.intersection(
      jsonObjectSchema,
      z22.object({
    ...
    output_tokens_details: z22.intersection(
      jsonObjectSchema,
      z22.object({
    ...
    total_tokens: z22.number().optional()
  })
);
...
var openaiLanguageModelResponsesOptionsSchema = lazySchema21(
  () => zodSchema21(
    z23.object({
       ...
       */
      reasoningEffortUpdate: z23.enum(["low", "medium", "high", "xhigh", "max"]).optional(),
      /**
